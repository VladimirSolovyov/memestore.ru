  ...
  <div id="collapse-coupon" class="panel-collapse collapse">
    <div class="panel-body">
      ...
      <div class="input-group">
        ...
        <input type="button" style="height: 34px; line-height: 20px; border-radius: 0;" value="<?php echo $button_coupon; ?>" id="button-coupon" data-loading-text="<?php echo $text_loading; ?>"  class="btn btn-primary" />
        </span></div>
